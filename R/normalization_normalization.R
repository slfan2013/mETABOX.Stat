...
normalization_normalization <- function(e1,f1,p1,
                                        ...
                                        fileName = NULL,compoundName=NULL,sampleName=NULL
                                             ){
  ...
  return(list(e2=e1.3,f2=f1,p2=p1,method=method,fileName=fileName,compoundName=compoundName,sampleName=sampleName))
}
