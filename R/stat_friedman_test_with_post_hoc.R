#'stat_friedman_test_with_post_hoc
...
stat_friedman_test_with_post_hoc <- function(formu, data, to.print.friedman = F, to.post.hoc.if.signif = T,  to.plot.parallel = F, to.plot.boxplot = F, signif.P = .05, color.blocks.in.cor.plot = F, jitter.Y.in.cor.plot =F)
{
